            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  {/* Recommandation basée sur les créneaux */}
                  {timeSlotAnalysis.evening.count > timeSlotAnalysis.morning.count && (
                    <div className="p-4 rounded-lg bg-green-50 border-l-4 border-l-green-500">
                      <div className="flex items-start space-x-3">
                        <Clock className="h-5 w-5 mt-0.5 text-green-600" />
                        <div>
                          <h4 className="font-medium text-sm">Optimiser les horaires</h4>
                          <p className="text-sm text-muted-foreground mt-1">
                            Plus de cours en soirée qu'en matinée. Considérez rééquilibrer.
                          </p>
                        </div>
                      </div>
                    </div>
