                    ...
                    <div className="space-y-4">
                      ...
                      >
                        ...
                        >
                          <Badge
                            variant={
                              occupiedClassrooms > 0 ? 'default' : 'secondary'
                            }
                          >
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {Object.entries(timeSlotAnalysis).map(
                      ([key, slot], index) => (
                        <motion.div
                          key={key}
                        ...
                        >
                          ...
                          >
                            <Progress
                              value={
                                (slot.count / (courses?.length || 1)) * 100
                              }
                              className="mt-2"
                            />
                          </motion.div>
                    ...
                    {teacherWorkload.map((teacher, index) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          >
                            <span>
                              {teacher.weekCourses} cours cette semaine
                            </span>
                          ...
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              ...
                              <motion.p
                                ...
                                transition={{ duration: 0.5, delay: 0.9 }}
                              >
                                Certains enseignants sont surchargés.
                                Redistribuez les cours si possible.
                              </motion.p>
                            </div>
                          </div>
                        </motion.div>
