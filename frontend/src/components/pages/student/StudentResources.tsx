    ...
    <div className="container mx-auto p-4 sm:p-6 space-y-4 sm:space-y-6 max-w-7xl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex-1">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Mes Ressources</h1>
          <p className="text-muted-foreground mt-1 sm:mt-2 text-sm sm:text-base">
            Accédez à vos cours et documents pédagogiques
          </p>
        </div>
        <div className="self-center sm:self-auto">
          <BookOpenIcon className="h-8 w-8 sm:h-12 sm:w-12 text-primary" />
        </div>
      </div>
      ...
      <Card className="text-center py-8 sm:py-12">
        <CardContent>
          <DocumentTextIcon className="h-12 w-12 sm:h-16 sm:w-16 text-muted-foreground mx-auto mb-4" />
