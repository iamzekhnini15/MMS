  ...
  const features = [
    {
      ...
      description:
        'Organisez vos cours, matières et plannings en toute simplicité',
      color: 'text-blue-600',
      bgColor: 'bg-blue-50',
    },
    {
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            >
              Une plateforme complète pour gérer efficacement vos cours,
              enseignants, étudiants et ressources pédagogiques. Simplifiez
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8">
                Conçue par des professionnels de l'éducation, notre solution
                répond aux besoins réels des établissements scolaires modernes.
              </p>
