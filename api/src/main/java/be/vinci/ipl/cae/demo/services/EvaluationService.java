...
public class EvaluationService {
   ...
   * @return list of evaluations
   */
  public List<Evaluation> getEvaluationsBySubjectClassAndPeriod(Long subjectId, Long classId, Long periodId) {
    Subject subject = subjectRepository.findById(subjectId)
      .orElseThrow(() -> new IllegalArgumentException("Subject not found"));
    ClassEntity classEntity = classesRepository.findById(classId)
      .orElseThrow(() -> new IllegalArgumentException("Class not found"));
    ...
    return evaluationRepository.findBySubjectAndClassEntityAndBulletinPeriod(subject, classEntity, period);
  }
  ...
  public Evaluation createEvaluation(EvaluationDto dto) {
    ...
    evaluation.setIsGradesVisible(dto.getIsGradesVisible() != null ? dto.getIsGradesVisible() : false);
    evaluation.setType(dto.getType() != null ? dto.getType() : Evaluation.EvaluationType.INTERROGATION);
