...
public class StudentBulletinController {
  ...
  public ResponseEntity<List<StudentBulletin>> generateBulletinsForClass(
    ...
    try {
      ...
      List<StudentBulletin> bulletins = studentBulletinService.generateBulletinsForClass(classId,
          periodId, tempUser
      );
  ...
  public ResponseEntity<List<StudentBulletin>> getBulletinsByClassAndPeriod(
    ...
    try {
      List<StudentBulletin> bulletins = studentBulletinService.getBulletinsByClassAndPeriod(classId,
          periodId
      );
      return ResponseEntity.ok(bulletins);
    } catch (Exception e) {
  ...
  public ResponseEntity<List<StudentBulletin>> makeAllBulletinsVisible(
    ...
    try {
      List<StudentBulletin> bulletins = studentBulletinService.makeAllBulletinsVisible(classId,
          periodId
      );
      return ResponseEntity.ok(bulletins);
    } catch (Exception e) {
  ...
  public ResponseEntity<List<StudentBulletin>> getVisibleBulletinsByUserId(
