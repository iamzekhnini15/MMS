...
public interface EvaluationRepository extends JpaRepository<Evaluation, Long> {
   ...
   * @return list of evaluations
   */
  List<Evaluation> findBySubjectAndClassEntityAndBulletinPeriod(Subject subject, ClassEntity classEntity, BulletinPeriod period);
   ...
   */
  @Query("SELECT e FROM Evaluation e WHERE e.classEntity = :classEntity AND e.bulletinPeriod = :period AND e.isVisible = true")
  List<Evaluation> findVisibleEvaluationsByClassAndPeriod(@Param("classEntity") ClassEntity classEntity, @Param("period") BulletinPeriod period);
   ...
   * @return list of evaluations
   */
  List<Evaluation> findByClassEntityAndBulletinPeriod(ClassEntity classEntity, BulletinPeriod period);
}
